...
# DONE: 
methodsNames = [ 'KNN' ], 
# TODO , , 'DTree', 'NBayes', 'ExtraTrees', 'AdaBoost', 'SVMC', 'DAnalysisQuadratic', 'HistGradient'
...
##Variaveis globais
save_metrics_path = "E:/Datasets/DatasetBalanced/Results/csvs/"
base_path_parts = "E:/Datasets/DatasetBalanced/Features/"
...
if __name__ == '__main__':  
    for thresh in [0.2]:
        for partition in range(1,101):
            ...
            for method in range(0, len(methodsNames[0])):
                methodName = methodsNames[0][method]
                ...
                # calibrator = CalibratedClassifierCV(initClassifier, cv='prefit')
